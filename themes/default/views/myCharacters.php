<?php
	...
	$output .= '
		...
		<div class="container" style="border:1px solid #cecece;padding:10px;margin-bottom:100px;height:65vh;">
				...
				<div class="col-8" style="height:100%">
					...
					<div id="viewGeneral" class="container">
						<div class="row" style="margin-top:10px">
							<div class="col-6">
								<img style="width:75%;border: #000000 8px solid;" src="themes/default/images/portraits/'.$races[$selectedCharacter['race']].getCharacterGender($selectedCharacter['race']).$faces[$selectedCharacter['face']].'.jpg"/>
							</div>
							<div class="col-6">
					...
					<div id="viewSkills" class="container" style="height:90%;overflow:scroll;display:none;">
						<div class="row" style="margin-top:20px">
							<div class="col-12">
								<table class="table">
									<thead>
					...
					<div id="viewSpells" class="container" style="height:90%;overflow:scroll;display:none;">
						<div class="row" style="margin-top:20px">
							<div class="col-12">
								<table class="table">
									<thead>
					...
					<div id="viewInventory" class="container" style="height:90%;overflow:scroll;display:none;">
						<div class="row" style="margin-top:20px;">
					...
					<div id="viewJobs" class="container" style="height:90%;overflow:scroll;display:none;">
						<div class="row" style="margin-top:20px;">
							<div class="col-12">
								<table class="table">
									<thead>
					...
					<div id="viewCurrencies" class="container" style="height:90%;overflow:scroll;display:none;">
						<div class="row" style="margin-top:20px;">
							<div class="col-12">
								<table class="table">
									<thead>
